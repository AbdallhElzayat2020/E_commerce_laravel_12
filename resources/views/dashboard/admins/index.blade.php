                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="btn btn-primary" href="{{ route('dashboard.admins.create') }}">+
                                {{ __('admins.create_admin') }}</a>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a style="font-size: 18px!important;" href="#"
                                                            data-toggle="modal"
                                                            data-target="#delete_admin{{ $admin->id }}"
                                                            class="btn btn-danger mx-1" title="{{ __('tables.delete') }}">
                                                            <i class="la la-trash"></i>
                                                        </a>
                                                        <a href="#" data-toggle="modal"
                                                            data-target="#change_status_{{ $admin->id }}">
                                                            @if ($admin->status == 'active')
