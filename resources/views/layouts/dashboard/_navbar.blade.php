                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#"><i class="ft-align-left"></i> Multi level menu</a>
                                                <ul>
                                                    ...
                                                    <li><a class="dropdown-item" href="#"><i class="la la-floppy-o"></i> Second level, fourth link</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="color-palette-primary.html"><i class="ft-camera"></i> Color palette
                                                    system</a>
                                            </li>
                                            <li><a class="dropdown-item" href="sk-2-columns.html"><i class="ft-edit"></i> Page starter kit</a></li>
                                            <li><a class="dropdown-item" href="changelog.html"><i class="ft-minimize-2"></i> Change log</a></li>
                                            <li>
                                                <a class="dropdown-item" href="https:/pixinvent.ticksy.com/"><i class="la la-life-ring"></i> Customer
                                                    support center</a>
                                            </li>
                                        </ul>
                                    </li>
                ...
                <span class="mr-1">Hello,
                  ...
                  <img src="{{asset('assets/dashboard')}}/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span>
                    ...
                    <li class="nav-item dropdown dropdown-language">
                        <a class="nav-link dropdown-toggle" id="dropdown-lang" href="#" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false">
